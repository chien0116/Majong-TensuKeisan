...
public class jpoyatsumo extends AppCompatActivity {
    Button mangan, hanemann, baimann, sannbaimann, yakumann, or2400, or4800, or9600, or1500, or2900, or5800,
            ...
            or3900_2,or7700_2,or4400,or8700,or4800_3,or9600_3,or5300,or10600,button30,ot700,ot1300,ot2600;
    TextView textView18;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.jpoyatsumo);
        ...
        button30.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!currentText.isEmpty()) {
                    ...
                    Toast.makeText(jpoyatsumo.this, "請輸入点数", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
